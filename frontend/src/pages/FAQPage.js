...
const FAQPage = () => {
    ...
    const faqs = [
            ...
            answer: (
                <>
                    ...
                    <ol>
                        ...
                        <li>You can send us a message through the contact form or email us directly at <a href="mailto:revengeraaditya@gmail.com">revengeraaditya@gmail.com</a>.</li>
                    </ol>
                </>
            )
        },
        {
            ...
            answer: (
                <>
                    <p>Admins are usually invited by the platform owner. If you're interested in becoming an admin, please contact us at <a href="mailto:revengeraaditya@gmail.com">revengeraaditya@gmail.com</a>.</p>
    ...
    return (
        <section className="bg-light py-5">
            <div className="container py-4 px-3 rounded bg-white">
                ...
                <p>For any questions or concerns regarding these FAQs, please contact us at <a href="mailto:revengeraaditya@gmail.com">revengeraaditya@gmail.com</a>.</p>
            </div>
        </section>
    );
};
