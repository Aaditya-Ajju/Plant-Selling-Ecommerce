            ...
            <div className="container py-4 px-3 rounded bg-white">
                ...
                <section id="bug-report" className="section-title">
                    ...
                    <p>
                        ...
                        <a
                            href="https://github.com/Aaditya-Ajju/Plant-Selling-Website/issues"
                            target="_blank"
                ...
                <section id="contribute" className="section-title">
                    ...
                    <p>
                        ...
                        <a
                            href="https://github.com/Aaditya-Ajju/Plant-Selling-Website"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            GitHub Repository
                ...
                <section id="contact-us" className="section-title">
                    ...
                    <p className="card-text mb-0">Email: <Link to="mailto:revengeraaditya@gmail.com">revengeraaditya@gmail.com</Link></p>
                    <p>
                        <strong>Phone:</strong>
                        <Link to="tel:+919798503975"> +919798503975</Link>
                    </p>
                    <p>
                ...
                <div className="social-icons">
                    <p>Social Links</p>
                    <Link to="https://www.facebook.com/profile.php?id=100052826911456" className="me-4 link-secondary">
                        <i className="fab fa-facebook-f"></i>
                    </Link>
                    
                    <Link to="https://www.instagram.com/i_m_innocent_aadi?igsh=MTF1ZGR6ZWlkbXZiZg==" className="me-4 link-secondary">
                        <i className="fab fa-instagram"></i>
                    </Link>
                    <Link to="https://www.linkedin.com/in/aaditya-raj-klu/" className="me-4 link-secondary">
                        <i className="fab fa-linkedin"></i>
                    </Link>
                    <Link to="https://github.com/Aaditya-Ajju" className="me-4 link-secondary">
