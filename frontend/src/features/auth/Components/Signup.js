        ...
        <div className='d-flex justify-content-center py-2 px-2 mb-4 mb-md-5'>
            <div className='col-12 col-md-8 col-lg-6 col-xl-4 shadow border rounded px-2 py-2 p-md-5'>
                ...
                <div className="text-center mb-3">
                    ...
                    <div>
                        <i className="fab fa-facebook-f mx-2 cursor-pointer" onClick={() => handleSocialLoginClick("Facebook")}></i>
                        <i className="fab fa-google mx-2" onClick={() => handleSocialLoginClick("Google")}></i>
                        <i className="fab fa-twitter mx-2" onClick={() => handleSocialLoginClick("Twitter")}></i>
                        <i className="fab fa-github mx-2" onClick={() => handleSocialLoginClick("GitHub")}></i>
                    </div>
                </div>
