...
function Login() {
    ...
    const handleSocialLoginClick = (platform) => {
        message.info(`Social login with ${platform} is coming soon!`);
    };
            ...
            <div className='col-12 col-md-8 col-lg-6 col-xl-4 shadow border rounded px-2 py-2 p-md-5'>
                ...
                <div className="row p-3">
                    <p className="text-center login-social-link m-0">
                        <i className="fab fa-facebook-f ms-4 cursor-pointer" onClick={() => handleSocialLoginClick("Facebook")}></i>
                        <i className="fab fa-google ms-4" onClick={() => handleSocialLoginClick("Google")}></i>
                        <i className="fab fa-twitter ms-4" onClick={() => handleSocialLoginClick("Twitter")}></i>
                        <i className="fab fa-github ms-4" onClick={() => handleSocialLoginClick("GitHub")}></i>
                    </p>
                </div>
                <div className="row">
