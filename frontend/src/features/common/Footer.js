                        ...
                        <div className="d-flex flex-column flex-md-row mt-3 mt-md-0">
                            ...
                            <div className="d-flex flex-wrap justify-content-between align-items-start col-md-8 col-lg-6">
                                ...
                                <div className="d-flex flex-column align-items-start pe-3">
                                    ...
                                    <p><i className="far fa-address-card me-3 text-secondary"></i>Name: Aaditya Raj, Aurangabad, Bihar, India.</p>
                                    <p>
                                        <Link to="mailto:revengeraaditya@gmail.com" className='text-light'>
                                            <i className="fas fa-envelope me-3 text-secondary"></i>
                                            revengeraaditya@gmail.com
                                        </Link>
                                    </p>
                                    <p>
                                        <Link to="tel:+919798503975" className='text-light'>
